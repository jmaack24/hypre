...
__global__ void
hypreCUDAKernel_CSRMatrixComputePermutedRowPtrs(HYPRE_Int n,
                                                HYPRE_Int *perm,
                                            ...
                                            HYPRE_Int *row_ptrs_out)
{
   ...
   HYPRE_CUDA_LAUNCH( hypreCUDAKernel_CSRMatrixComputePermutedRowPtrs, gDim, bDim, n,
...
__global__ void
hypreCUDAKernel_CSRMatrixPermuteColsVals(HYPRE_Int num_rows, HYPRE_Int nnz, HYPRE_Int threads_per_row,
...
{
   HYPRE_Int tid = threadIdx.x%threads_per_row;
   HYPRE_Int rowSmall = threadIdx.x/threads_per_row;
                                     ...
                                     HYPRE_Int * dst_i, HYPRE_Int * dst_j, HYPRE_Complex * dst_data)
{
   ...
   HYPRE_CUDA_LAUNCH( hypreCUDAKernel_CSRMatrixPermuteColsVals, gDim, bDim, nrows, nnz, threads_per_row,
