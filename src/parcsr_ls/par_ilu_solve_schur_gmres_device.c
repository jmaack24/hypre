   ...
   if ( A_diag_n > 0 )
   {
      if (isDoublePrecision)
      {
         ...
         HYPRE_CUSPARSE_CALL(cusparseDcsrsv2_solve(handle, CUSPARSE_OPERATION_NON_TRANSPOSE,
                                                   A_diag_n, A_diag_nnz, (hypre_double *) &one,
                                                   hypre_GpuMatDataMatDescr(hypre_ParILUDataMatLMatData(ilu_data)),
                                                   (hypre_double *) A_diag_data, A_diag_i, A_diag_j,
                                                   hypre_CsrsvDataInfoL(hypre_ParILUDataMatSLUCsrsvData(ilu_data)),
                                                   (hypre_double *) xtemp_data, (hypre_double *) ytemp_data,
         ...
         HYPRE_CUSPARSE_CALL(cusparseDcsrsv2_solve(handle, CUSPARSE_OPERATION_NON_TRANSPOSE,
                                                   ...
                                                   (hypre_double *) ytemp_data, (hypre_double *) xtemp_data,
                                                   hypre_CsrsvDataSolvePolicy(hypre_ParILUDataMatSLUCsrsvData(ilu_data)),
                                                   hypre_CsrsvDataBuffer(hypre_ParILUDataMatSLUCsrsvData(ilu_data))));
      }
      else if (isSinglePrecision)
      {
         ...
         HYPRE_CUSPARSE_CALL(cusparseScsrsv2_solve(handle, CUSPARSE_OPERATION_NON_TRANSPOSE,
                                                   A_diag_n, A_diag_nnz, (float *) &one,
                                                   hypre_GpuMatDataMatDescr(hypre_ParILUDataMatLMatData(ilu_data)),
                                                   (float *) A_diag_data, A_diag_i, A_diag_j,
                                                   hypre_CsrsvDataInfoL(hypre_ParILUDataMatSLUCsrsvData(ilu_data)),
                                                   (float *) xtemp_data, (float *) ytemp_data,
                                                   hypre_CsrsvDataSolvePolicy(hypre_ParILUDataMatSLUCsrsvData(ilu_data)),
                                                   hypre_CsrsvDataBuffer(hypre_ParILUDataMatSLUCsrsvData(ilu_data))));
         ...
         HYPRE_CUSPARSE_CALL(cusparseScsrsv2_solve(handle, CUSPARSE_OPERATION_NON_TRANSPOSE,
                                                   ...
                                                   (float *) A_diag_data, A_diag_i, A_diag_j,
                                                   hypre_CsrsvDataInfoU(hypre_ParILUDataMatSLUCsrsvData(ilu_data)),
                                                   (float *) ytemp_data, (float *) xtemp_data,
                                                   hypre_CsrsvDataSolvePolicy(hypre_ParILUDataMatSLUCsrsvData(ilu_data)),
                                                   hypre_CsrsvDataBuffer(hypre_ParILUDataMatSLUCsrsvData(ilu_data))));
